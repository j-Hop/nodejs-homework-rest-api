...
router.put("/:contactId",isValidId, isEmptyBody,validateBody(contactUpdateShema) , contactsController.updateContacts);

router.patch("/:contactId/favorite", isValidId, isEmptyBody, validateBody(contactFavoriteSchema), contactsController.updateContacts);
